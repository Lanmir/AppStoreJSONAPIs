...
class AppDetailCell: UICollectionViewCell {
    ...
    var app: Result! { // directly referencing the cell for setting views
        didSet{
    ...
    override init(frame: CGRect) {
        ...
        priceButton.backgroundColor = #colorLiteral(red: 0, green: 0.6025093287, blue: 1, alpha: 1)
...
extension UIStackView {
    convenience init(arrangedSubviews: [UIView], customSpacing:CGFloat = 0) { // custom Spacing for horizontal spacing
